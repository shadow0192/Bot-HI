...
let out
try {
stiker = await شsticker(img, false, global.packname, global.author)
} catch (e) {
console.error(e)
} finally {
if (!stiker) {
...
else return m.reply('*عنوان URL / الرابط غير صالح ، يجب أن يكون إنهاء الرابط / URL / الرابط هو jpg ، على سبيل المثال #s https://telegra.ph/file/313420fffb640d976bba1.jpg*')
